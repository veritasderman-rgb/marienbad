...
export async function generateMetadata({ params }: Props) {
  ...
  return { title: `${title} | Things to Do | Marienbad.com` }
}

export default async function ThingsToDoArticle({ params }: Props) {
    ...
    <article>
      <header className="bg-primary-950 text-white py-16 md:py-20">
        <div className="container-narrow">
          <p className="text-accent-400 text-sm font-medium uppercase tracking-wider mb-4">Things to Do</p>
      ...
      <div className="container-wide py-12 md:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <aside className="lg:col-span-1">
            <EnsanaCTABox url="https://www.ensanahotels.com/hvezda" campaign={slug} position="sidebar" />
          </aside>
        </div>
      </div>
    </article>
