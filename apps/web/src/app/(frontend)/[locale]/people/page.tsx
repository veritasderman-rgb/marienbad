...
const placeholderStories: StoryData[] = [
  ...
  {
    slug: 'james-london-first-time',
    name: 'James',
    country: 'United Kingdom',
    visitNumber: '1',
    headline: 'James, London. First time.',
    pullQuote: 'I expected old. I found magic. The singing fountain at sunset changed everything.',
    archetype: 'first-visit',
  },
  {
    slug: 'tatyana-moscow-healing',
    name: 'Татьяна',
    country: 'Россия',
    headline: 'Татьяна, Москва. Каждый год.',
    pullQuote: 'Доктор сказал шесть месяцев. Четыре года назад. Я приезжаю каждый год.',
    archetype: 'healing',
  },
  {
    slug: 'ingrid-hamburg-erinnerung',
    name: 'Ingrid',
    country: 'Deutschland',
    visitNumber: '37',
    headline: 'Ingrid, Hamburg. Zum 37. Mal.',
    pullQuote: 'Mein Mann hat mich hierher zum ersten Mal mitgenommen. 1989 war das. Hier fühle ich ihn noch.',
    archetype: 'love',
  },
  {
    slug: 'marie-generace',
    ...
    headline: 'Marie, Praha. Tři generace.',
    pullQuote: 'Babička přivezla mámu. Máma přivezla mě. A já teď přivážím dceru.',
    archetype: 'generation',
  },
  {
    slug: 'yuki-tokyo-onsen',
    name: 'Yuki',
    country: 'Japan',
    headline: 'Yuki, Tokyo. First visit.',
    pullQuote: 'In Tokyo we have onsen. Nothing like this. The architecture, the silence, the water.',
    archetype: 'faraway',
  },
]
  ...
  return (
    <div>
      ...
      <section className="container-wide py-12 md:py-16">
        <StoryGrid stories={placeholderStories} />
      </section>
