...
export async function generateMetadata({ params }: Props) {
  ...
  return { title: `${title} | History | Marienbad.com` }
}

export default async function HistoryArticle({ params }: Props) {
    ...
    <article>
      <header className="bg-primary-950 text-white py-16 md:py-20">
        <div className="container-narrow">
          <p className="text-accent-400 text-sm font-medium uppercase tracking-wider mb-4">History & Culture</p>
