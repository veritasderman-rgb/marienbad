...
const cs: CorporateContent = {
    ...
    items: [
      {
        ...
        body: 'Mramorový sál má fresky, lustry a parket, na kterém se tančí od roku 1867. Vaši lidé přespí v hotelu propojeném chodbou — nikdo neřeší taxíky ani kdo dnes nepije. Ráno je čeká snídaně a pro ty, kdo chtějí, bazén. Menší firmy mají Červený sál se stejnou atmosférou v komornějším měřítku. Živou hudbu, DJ, catering podle vašeho přání i květinovou výzdobu zajistíme my.',
      ...
      },
      {
        ...
        body: 'Edwardova knihovna v pětihvězdičkových Nových Lázních: nádherná knihovna, denní světlo, koberec a na prezentaci se sem vejde až 50 osob. Oběd v restauraci Royal o pár kroků dál a po jednání Římské lázně z roku 1896 nebo minerální koupel v Královské kabině Edwarda VII. Pro nejužší okruh je vedle Zelený salonek pro dvacet lidí u jednoho stolu.',
  ...
  day: {
    ...
    items: [
      ...
      { time: '21:00', title: 'Lobby bar', text: 'Posezení v hotelovém lobby baru s vynikající nabídkou vín — a pár kroků do postele.' },
    ],
