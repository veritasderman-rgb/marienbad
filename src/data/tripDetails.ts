...
export const tripLongDescriptions: Record<string, Record<Locale, string[]>> = {
  ...
  'boheminium': {
    de: [
      ...
      "Der Park liegt in den Wäldern oberhalb der Stadt beim Hotel Krakonoš; man erreicht ihn auf einem angenehmen Spaziergang durch die Kurwälder, mit dem Stadtbus, der den Park regelmäßig anfährt — oder mit der historischen Kabinenseilbahn von der Talstation Koliba (April–Oktober). Das Gelände ist ganzjährig geöffnet, mit Bistro und Kinderstationen — und dank befestigter Wege auch mit dem Kinderwagen bequem zu bewältigen.",
    ],
    en: [
      ...
      "The park lies in the woods above the town by the Krakonoš hotel; you reach it on a pleasant walk through the spa forests, by the regular city bus that serves the park — or by the historic cabin cable car from the Koliba bottom station (April–October). The grounds are open year-round, with a bistro and children's stops — and thanks to the paved paths, it is easily managed with a stroller.",
    ],
    cs: [
      ...
      "Park leží v lesích nad městem u hotelu Krakonoš; dojdete sem příjemnou procházkou lázeňskými lesy, dojedete autobusem MHD, který sem pravidelně zajíždí — nebo vyjedete historickou kabinkovou lanovkou od dolní stanice Koliba (duben–říjen). Areál je otevřený celoročně, s bistrem a dětskými zastaveními — a protože jsou cesty zpevněné, zvládnete ho pohodlně i s kočárkem.",
    ],
    ru: [
      ...
      "Парк лежит в лесах над городом у отеля «Крконош»; сюда приятно дойти пешком через курортные леса, доехать на городском автобусе, который регулярно сюда заходит, — или подняться на исторической кабинной канатной дороге от нижней станции Колиба (апрель–октябрь). Территория открыта круглый год, есть бистро и детские остановки — а благодаря мощёным дорожкам парк легко пройти и с коляской.",
    ],
  },
  'soos': {
    de: [
