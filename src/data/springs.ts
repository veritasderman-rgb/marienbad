...
export const springs: Spring[] = [
  ...
  },
  {
    ...
    detail: {
      de: "Ursprünglich hieß sie Neue Quelle; den Namen der Kaiserin Karoline Auguste erhielt sie 1817. Der hohe Magnesiumanteil macht sie zur klassischen Wahl bei Nierensteinen — und ihr ist die klassizistische Karolinenbrunnen-Kolonnade gewidmet, eines der meistfotografierten Bauwerke der Stadt.",
      en: "Originally called the New Spring, it received Empress Caroline Augusta's name in 1817. Its high magnesium share makes it the classic choice for kidney stones — and it lends its name to the neoclassical Caroline Spring colonnade, one of the town's most photographed structures.",
      cs: "Původně se jmenoval Nový pramen; jméno císařovny Karolíny Augusty dostal roku 1817. Vysoký podíl hořčíku z něj dělá klasickou volbu při ledvinových kamenech — a právě jemu je zasvěcena klasicistní kolonáda Karolinina pramene, jedna z nejfotografovanějších staveb města.",
      ru: "Первоначально он назывался Новым источником; имя императрицы Каролины Августы получил в 1817 году. Высокая доля магния делает его классическим выбором при почечных камнях — именно ему посвящена классицистская колоннада источника Каролины, одно из самых фотографируемых сооружений города.",
    },
    location: 'colonnade',
    type: 'drinking',
    indications: ['kidneys'],
    ...
    description: {
      de: 'Benannt nach Kaiserin Karoline Auguste, verdankt die Quelle ihren Ruf dem außergewöhnlich hohen Magnesiumgehalt — traditionell empfohlen bei Nierensteinen. Ihr Pavillon gehört zum Ensemble rund um die Kolonnade, wenige Schritte von der Singenden Fontäne.',
      en: 'Named after Empress Caroline Augusta, the spring owes its reputation to an exceptionally high magnesium content — traditionally recommended for kidney stones. Its pavilion belongs to the colonnade ensemble, steps from the Singing Fountain.',
      cs: 'Pramen pojmenovaný po císařovně Karolíně Augustě vděčí za svou pověst mimořádně vysokému obsahu hořčíku — tradičně se doporučuje při ledvinových kamenech. Jeho pavilon patří k souboru staveb kolem kolonády, pár kroků od Zpívající fontány.',
      ru: 'Источник, названный в честь императрицы Каролины Августы, обязан репутацией исключительно высокому содержанию магния — его традиционно рекомендуют при почечных камнях. Павильон входит в ансамбль колоннады, в нескольких шагах от Поющего фонтана.',
    },
  },
  {
    id: 'lesni',
