...
export const diagnoses: Diagnosis[] = [
  {
    ...
    content: {
      ...
      ru: {
        slug: 'artroz',
        navLabel: 'Артроз',
        title: 'Курортное лечение артроза в Марианские Лазне',
        h1: 'Курортное лечение артроза',
        metaTitle: 'Лечение артроза в Марианские Лазне | Marienbad.com',
        metaDescription: 'Артроз коленного, тазобедренного суставов и кистей: какие процедуры применяются в Марианские Лазне, сколько длится пребывание и когда лечение не показано.',
        lead: 'Артроз — самый частый диагноз, с которым гости приезжают в Марианские Лазне. Лечение опирается на углекислые ванны из местной минеральной воды, торфяные обёртывания и ежедневную физиотерапию — сочетание, которое амбулаторная реабилитация в таком объёме обеспечить не может.',
        ...
        faqs: [
          ...
          },
          {
            ...
            answer: 'Цена зависит от отеля, категории номера, питания и количества процедур, а не от диагноза. Курортные пакеты отелей Марианские Лазне включают первичный осмотр, назначенные врачом процедуры, полу- или полный пансион и проживание в одной цене. Актуальный обзор цен приведён в путеводителе по стоимости лечения.',
          },
          {
            question: 'Можно ли поехать на лечение с искусственным суставом?',
            answer: 'Да, состояния после замены сустава — отдельная позиция индикационного списка, и в Марианские Лазне их лечат регулярно. Условие — завершённое заживление раны и разрешение оперировавшего врача. Подробности — на странице о лечении после операции на тазобедренном суставе.',
          },
        ],
        sources: [
          {
        ...
        related: [
          ...
          {
            label: 'Сколько стоит лечение в Марианские Лазне',
  ...
  },
  {
    ...
    content: {
      ...
      ru: {
        ...
        title: 'Курортное лечение после операции на тазобедренном суставе в Марианские Лазне',
        h1: 'Курортное лечение после операции на тазобедренном суставе',
        metaTitle: 'После операции на бедре — Марианские Лазне | Marienbad.com',
        metaDescription: 'Реабилитация после операции на тазобедренном суставе в Марианские Лазне: какие процедуры применяются после эндопротезирования, сроки и когда рано ехать.',
        lead: 'После тотального эндопротезирования тазобедренного сустава или другой операции на нём курортное лечение продолжает работу там, где амбулаторная физиотерапия достигает предела: ежедневные, назначенные врачом процедуры на протяжении нескольких недель. В Марианские Лазне для этого сочетают физиотерапию на суше с двигательной терапией в тёплой воде, которая даёт свежепрооперированному суставу опору вместо нагрузки.',
        ...
        faqs: [
          {
            ...
            answer: 'Состояния после ортопедических операций с заменой сустава — отдельная позиция чешского индикационного списка (VII/10), и в Марианские Лазне их лечат регулярно: индивидуальной физиотерапией, двигательной терапией в воде и обучением ходьбе под ежедневным врачебным контролем. Какой отель и какая программа подойдут, зависит от типа протеза и текущего этапа восстановления.',
          },
          {
          ...
          },
          {
            ...
            answer: 'Да — коксартроз является отдельным, часто встречающимся показанием в Марианские Лазне и при необходимости лечится в рамках того же пребывания. Подробности — на странице о лечении артроза.',
          },
        ],
        sources: [
          {
  ...
  },
  {
    ...
    content: {
      ...
      ru: {
        ...
        title: 'Курортное лечение после операции на коленном суставе в Марианские Лазне',
        h1: 'Курортное лечение после операции на коленном суставе',
        metaTitle: 'После операции на колене — Марианские Лазне | Marienbad.com',
        metaDescription: 'Реабилитация после операции на колене в Марианские Лазне: процедуры после эндопротезирования или операции на мениске, сроки и когда лечение показано.',
        lead: 'После тотального эндопротезирования коленного сустава или другой операции на колене суставу прежде всего нужно одно: регулярная, направляемая тренировка сгибания и мышц бедра. Для этого курортное лечение в Марианские Лазне объединяет ежедневную индивидуальную физиотерапию с двигательной терапией в тёплой воде, где выталкивающая сила снимает нагрузку со свежепрооперированного колена.',
        ...
        faqs: [
          {
            ...
            answer: 'Для состояний после эндопротезирования колена или других операций на колене чешский индикационный список предусматривает отдельные позиции (VII/10 и VII/11), и в Марианские Лазне их лечат ежедневной индивидуальной физиотерапией, двигательной терапией в воде и обучением ходьбе. Какая программа подойдёт, зависит от вмешательства и текущего угла сгибания и определяется при первичном осмотре.',
          },
          {
  ...
  },
  {
    ...
    content: {
      ...
      ru: {
        ...
        title: 'Курортное лечение заболеваний позвоночника в Марианские Лазне',
        h1: 'Курортное лечение позвоночника и болей в спине',
        metaTitle: 'Лечение позвоночника в Марианские Лазне | Marienbad.com',
        metaDescription: 'Курортное лечение позвоночника в Марианские Лазне: процедуры при хронических болях в спине, после операции на диске, сроки и данные исследований.',
        lead: 'Хронические боли в спине и состояния после операций на позвоночнике — одна из самых частых причин обращения за курортным лечением в Марианские Лазне. Лечение сочетает тепло торфяных обёртываний, электротерапию и ежедневную школу спины — интенсивность, которую еженедельный амбулаторный сеанс физиотерапии обеспечить не может.',
  ...
  },
  {
    ...
    content: {
      ...
      ru: {
        ...
        navLabel: 'Ревматизм',
        title: 'Курортное лечение ревматизма в Марианские Лазне',
        h1: 'Курортное лечение ревматоидного артрита и ревматизма',
        metaTitle: 'Лечение ревматизма в Марианские Лазне | Marienbad.com',
        metaDescription: 'Ревматоидный артрит и болезнь Бехтерева: какие процедуры применяются в Марианские Лазне при ревматизме, сколько длится лечение и что показывают исследования.',
        lead: 'Ревматоидный артрит — хроническое воспалительное заболевание суставов, при котором наряду с медикаментозной базисной терапией нужна сопутствующая реабилитация. В Марианские Лазне ревматизм выделен в чешском индикационном списке как отдельная группа; для его лечения сочетают назначенную врачом двигательную терапию, физиотерапию и — в стабильные периоды болезни — тепловые и водные процедуры.',
        ...
        related: [
          ...
          {
            label: 'Торфяная терапия — природное сокровище Марианских Лазне',
  ...
  },
  {
    ...
    content: {
      ...
      ru: {
        slug: 'psoriaz',
        navLabel: 'Псориаз',
        title: 'Курортное лечение псориаза в Марианские Лазне',
        h1: 'Курортное лечение псориаза',
        metaTitle: 'Лечение псориаза в Марианские Лазне | Marienbad.com',
        metaDescription: 'Псориаз в Марианские Лазне: минеральные ванны, фототерапия и климатотерапия, сколько длится лечение и что показывают исследования ванн.',
        lead: 'Псориаз — хроническое воспалительное заболевание кожи с шелушащимися бляшками, протекающее обострениями. В Марианские Лазне генерализованный псориаз обыкновенный выделен как отдельная позиция чешского индикационного списка; для его лечения сочетают минеральные ванны, назначенную дерматологом фототерапию и мягкую климатотерапию курорта.',
        ...
        faqs: [
          ...
          {
            question: 'Марианские Лазне — это как Мёртвое море для кожи?',
            answer: 'Нет. Марианские Лазне — курорт в глубине Чехии с умеренным климатом, не морской климатический курорт. Применяемые здесь фототерапия и климатотерапия основаны на дозированном дерматологом УФ-B облучении и лесном воздухе, а не на высотном климате или солёности, сопоставимых с Мёртвым морем.',
          },
          {
  ...
  },
  {
    ...
    content: {
      ...
      ru: {
        ...
        title: 'Курортное лечение при камнях в почках в Марианские Лазне',
        h1: 'Курортное лечение при камнях в почках',
        metaTitle: 'Лечение камней в почках — Марианские Лазне | Marienbad.com',
        metaDescription: 'Камни в почках в Марианские Лазне: как проходит питьевой курс из минеральных источников, сколько длится пребывание и что показывают исследования.',
        lead: 'Камни в почках — один из старейших поводов для лечения в Марианские Лазне: богатые гидрокарбонатами минеральные источники курорта используются для питьевого курса ещё с XIX века. Чешский индикационный список выделяет нефролитиаз без задержки мочи как отдельную позицию, дополненную последующим лечением после вмешательств на почках и мочевых путях.',
        ...
        sources: [
          ...
          },
          {
            title: 'Institut lázeňství a balneologie & Léčebné lázně Mariánské Lázně 2026, ClinicalTrials.gov (NCT07435844)',
            url: 'https://clinicaltrials.gov/study/NCT07435844',
            note: 'Проводимое клиническое исследование курортного лечения при урологических и нефрологических диагнозах в Марианские Лазне, более 100 пациентов. Результаты пока не опубликованы.',
          },
        ],
        related: [
          {
  ...
  },
  {
    ...
    content: {
      ...
      ru: {
        ...
        title: 'Курортное лечение урологических заболеваний в Марианские Лазне',
        h1: 'Курортное лечение урологических заболеваний',
        metaTitle: 'Урологические заболевания — Марианские Лазне | Marienbad.com',
        metaDescription: 'Хронические воспаления мочевых путей, состояния после операции на простате и хронический простатит: лечение, питьевой курс и сроки в Марианские Лазне.',
        lead: 'Среди урологических заболеваний чешский индикационный список выделяет, в частности, хронические, резистентные к терапии воспаления почек и мочевых путей, состояния после операций на почках и мочевых путях, а также хронический простатит. В Марианские Лазне эту группу лечат с XIX века прежде всего питьевым курсом из собственных минеральных источников, дополненным назначенной урологом физиотерапией.',
        ...
        faqs: [
          ...
          {
            question: 'Подходят ли источники Марианские Лазне при воспалениях мочевых путей?',
            answer: 'При острых, лихорадочных инфекциях сначала необходимо антибактериальное лечение, а не курортное. Для рецидивирующих или хронических, устойчивых к антибиотикам воспалений почек и мочевых путей при постоянном урологическом наблюдении в Марианские Лазне выделено отдельное показание (VIII/1); контролируемые российские исследования описывают на фоне дополнительного питьевого курса снижение клинических жалоб и стерильные посевы мочи у большинства пролеченных пациентов.',
          },
          {
  ...
  },
  {
    ...
    content: {
      ...
      ru: {
        ...
        title: 'Курортное лечение после лечения онкологии в Марианские Лазне',
        h1: 'Курортное лечение после лечения онкологии',
        metaTitle: 'После лечения онкологии — Марианские Лазне | Marienbad.com',
        metaDescription: 'Восстановление после онкологического лечения в Марианские Лазне: программа под наблюдением врача для физической формы и питания — условия, ход, сроки.',
        lead: 'Для гостей, завершивших лечение онкологического заболевания, в Марианские Лазне предлагается курортная программа под наблюдением врача для восстановления физической формы, питания и душевного равновесия. Условие — завершённое комплексное лечение онкологического заболевания без признаков рецидива; лечение не заменяет онкологическое наблюдение.',
        ...
        faqs: [
          {
            ...
            answer: 'Да. Ensana предлагает в Марианские Лазне в отелях Nové Lázně и Hvězda специализированную постонкологическую программу для гостей после завершённого лечения онкологического заболевания. Она сочетает минеральные ванны, физиотерапию, консультации по питанию и психологическую поддержку под наблюдением врача, доступна от минимальной длительности семь ночей.',
          },
          {
            question: 'Какие курорты подходят онкологическим пациентам после лечения?',
            answer: 'Подходят курорты с курортной программой под наблюдением врача, специально для периода после онкологического лечения, а не любой wellness-отдых. В Марианские Лазне основа — официальное показание I/1: онкологические случаи после завершённого комплексного лечения без признаков рецидива, дополненное специализированной программой отеля с первичным осмотром и еженедельным врачебным контролем.',
          },
          {
          ...
          {
            question: 'Что включает постонкологическая курортная программа в Марианские Лазне?',
  ...
  },
  {
    ...
    content: {
      ...
      ru: {
        ...
        title: 'Курортное лечение заболеваний дыхательных путей в Марианские Лазне',
        h1: 'Курортное лечение заболеваний дыхательных путей',
        metaTitle: 'Лечение дыхательных путей — Марианские Лазне | Marienbad.com',
        metaDescription: 'Лечение астмы и ХОБЛ в Марианские Лазне: ингаляции, дыхательная гимнастика и климатотерапия — для кого и сколько длится.',
        lead: 'Хронические заболевания дыхательных путей, такие как астма, ХОБЛ или рецидивирующий бронхит, образуют в Марианские Лазне отдельную группу показаний. Лечение опирается на ингаляции из богатого углекислотой Лесного источника, дыхательную гимнастику и официально признанный с 2023 года лечебный климат на высоте около 630 метров.',
  ...
  },
  {
    ...
    content: {
      ...
      ru: {
        ...
        title: 'Курортное лечение заболеваний пищеварения в Марианские Лазне',
        h1: 'Курортное лечение заболеваний пищеварения',
        metaTitle: 'Лечение пищеварения — Марианские Лазне | Marienbad.com',
        metaDescription: 'Курортное лечение пищеварения в Марианские Лазне: питьевой курс из Крестового источника, диета и индикационный список — что лечат и сколько длится.',
        lead: 'Марианские Лазне прославились водой, известной своим действием на пищеварение ещё до появления первого курортного отеля. Лечение заболеваний пищеварения опирается на питьевой курс из сульфатных источников, таких как Крестовый источник, индивидуальную диетическую программу и врачебное сопровождение на протяжении нескольких недель.',
  ...
  },
  {
    ...
    content: {
      ...
      ru: {
        ...
        title: 'Курортное лечение нарушений обмена веществ и диабета в Марианские Лазне',
        h1: 'Курортное лечение нарушений обмена веществ и диабета',
        metaTitle: 'Лечение диабета — Марианские Лазне | Marienbad.com',
        metaDescription: 'Лечение диабета и обмена веществ в Марианские Лазне: питьевой курс, движение и диета — оплачиваемое показание и ход лечения.',
        lead: 'Сахарный диабет — единственное показание группы обмена веществ, оплачиваемое чешской страховой; избыточный вес и подагра традиционно тоже лечат в Марианские Лазне, но отдельной оплачиваемой позиции для них нет. Лечение сочетает назначенный врачом питьевой курс из сульфатных источников с движением и диетической программой.',
        ...
        faqs: [
          ...
          },
          {
            ...
            answer: 'Ожирение не является отдельной оплачиваемой позицией, но в Марианские Лазне традиционно лечится в рамках лечения для гостей, оплачивающих его самостоятельно. В рандомизированном исследовании с 257 участниками индекс массы тела через год после трёхнедельной курортной программы снизился сильнее, чем при обычном лечении; решающим было при этом сочетание движения, диеты и регулярности, а не отдельная процедура.',
          },
          {
            question: 'Какой источник в Марианские Лазне помогает при обмене веществ?',
          ...
          },
          {
            ...
            answer: 'Нет. В чешском индикационном списке только сахарный диабет (IV/1) образует отдельную оплачиваемую позицию группы обмена веществ. Избыточный вес и подагра в Марианские Лазне традиционно лечат дополнительно, обычно в рамках лечения для гостей, оплачивающих его самостоятельно, или как часть лечения диагнозов пищеварения и обмена веществ.',
          },
        ],
        sources: [
          {
