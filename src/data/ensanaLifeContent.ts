  ...
  cs: {
    ...
    tiers: {
      ...
      items: [
        ...
        },
        {
          ...
          perks: ['Dřívější příjezd podle dostupnosti', 'Přístup k největším slevovým akcím', 'Newsletter Ensana Life'],
        },
        {
          key: 'silver', name: 'Stříbrná', nights: '20+', nightsNote: 'nocí za poslední 2 roky', discount: '15 %', discountLabel: 'na ubytování i služby',
          perks: ['Dřívější příjezd i pozdější odjezd podle dostupnosti', 'Přístup k největším slevovým akcím', 'Newsletter Ensana Life'],
          featured: true,
        },
        {
          key: 'gold', name: 'Zlatá', nights: '40+', nightsNote: 'nocí za poslední 2 roky', discount: '20 %', discountLabel: 'na ubytování i služby',
          perks: ['Vyšší kategorie pokoje zdarma podle dostupnosti', 'Dřívější příjezd i pozdější odjezd podle dostupnosti', 'Přístup k největším slevovým akcím', 'Newsletter Ensana Life'],
        },
      ],
      ...
      comparison: [
        ...
        { label: 'Dřívější příjezd', values: ['—', 'ano', 'ano', 'ano'] },
        { label: 'Pozdější odjezd', values: ['—', '—', 'ano', 'ano'] },
    ...
    benefits: {
      ...
      cards: [
        ...
        { title: 'Komfort navíc při příjezdu', text: 'Od bronzové úrovně můžete přijet dříve, od stříbrné také odjet později a na zlaté získat vyšší kategorii pokoje zdarma — vždy podle aktuální dostupnosti.' },
      ],
    },
    steps: {
      ...
      items: [
        ...
        { title: 'Při příjezdu se vše ověří', text: 'Hotel zkontroluje údaje a stav členství. Po pobytu se noci připočtou k vaší úrovni.' },
      ],
    ...
    conditions: {
      ...
      items: [
        ...
        { title: 'Pobyty se všemi službami', text: 'Dřívější příjezd a pozdější odjezd u nich nelze čerpat zdarma. Člen ale může uplatnit slevu své úrovně na poplatek za tuto službu.' },
