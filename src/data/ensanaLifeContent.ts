  ...
  cs: {
    ...
    conditions: {
      ...
      items: [
        ...
        { title: 'Kdo se členem stát nemůže', text: 'Program je pro fyzické osoby starší 18 let. Nevztahuje se na právnické osoby ani na zaměstnance Ensany a přidružených společností. Jeden člen má jednu kartu a výhody nelze sdílet ani převádět.' },
      ],
  ...
  en: {
    ...
    conditions: {
      ...
      items: [
        ...
        { title: 'Who cannot join', text: 'The programme is for natural persons over 18. It does not apply to legal entities or to employees of Ensana and affiliated companies. One member holds one card, and benefits cannot be shared or transferred.' },
      ],
  ...
  ru: {
    ...
    conditions: {
      ...
      items: [
        ...
        { title: 'Кто не может стать участником', text: 'Программа предназначена для физических лиц старше 18 лет. Она не распространяется на юридических лиц и сотрудников Ensana и аффилированных компаний. У одного участника одна карта; преимущества нельзя передавать.' },
      ],
